...
| 8   | Scope Integrity         | `scope-integrity`         | 1.1.6            | `check:scope-integrity`                                                                                                                                         | claimed scope ≡ analyzed scope (ships with R4c)                                   |
...
| 11  | Agent Safety            | `agent-safety`            | 1.3.0            | `check:agent-safety`                                                                                                                                            | agent claims carry rescan evidence (ships with R8)                                |
| 12  | Artifact Integrity      | `artifact-integrity`      | 1.4.0            | `check:artifact-integrity`                                                                                                                                      | artifact bound to the claimed execution (ships with R9)                           |
