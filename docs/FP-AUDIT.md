...
| QA-CI-002    | 11%     | [0.031, 0.328]   | 18         | 16  | 2   | 0      | 4           | ❓ provisional |
| QA-CI-005    | 8%      | [0.0137, 0.3331] | 13         | 12  | 1   | 0      | 2           | 🔴 quarantine  |
| QA-CI-007    | 0%      | [0, 0.2588]      | 11         | 11  | 0   | 0      | 3           | ⚠️ extended    |
| QA-CI-008    | 10%     | [0.0179, 0.4042] | 10         | 9   | 1   | 0      | 4           | ❓ unmeasured  |
| QA-CI-009    | 0%      | [0, 0.2775]      | 10         | 10  | 0   | 0      | 3           | ❓ provisional |
...
| QA-CS-104    | 0%      | [0, 0.2775]      | 10         | 10  | 0   | 0      | 1           | ⚠️ extended    |
| QA-CS-105    | 25%     | [0.1018, 0.495]  | 16         | 12  | 4   | 0      | 2           | ⚠️ extended    |
| QA-CS-106    | 33%     | [0.1381, 0.6094] | 12         | 8   | 4   | 0      | 2           | 🔴 quarantine  |
| QA-CS-107    | 8%      | [0.0149, 0.3539] | 12         | 11  | 1   | 0      | 1           | ⚠️ extended    |
| QA-CS-109    | 0%      | [0, 0.2775]      | 10         | 10  | 0   | 0      | 1           | ⚠️ extended    |
...
| QA-JV-107    | 0%      | [0, 0.2775]      | 10         | 10  | 0   | 0      | 1           | ⚠️ extended    |
...
| QA-PW-116    | 0%      | [0, 0.2775]      | 10         | 10  | 0   | 0      | 1           | ✅ core        |
...
| QA-PW-124    | 7%      | [0.0119, 0.2982] | 15         | 14  | 1   | 0      | 2           | ✅ core        |
| QA-PW-125    | 0%      | [0, 0.2775]      | 10         | 10  | 0   | 0      | 1           | ⚠️ extended    |
...
| QA-PY-101    | 0%      | [0, 0.2775]      | 10         | 10  | 0   | 0      | 1           | ✅ core        |
...
| QA-PY-106    | 0%      | [0, 0.2153]      | 14         | 14  | 0   | 0      | 1           | ✅ core        |
| QA-PY-107    | 0%      | [0, 0.2775]      | 10         | 10  | 0   | 0      | 1           | ✅ core        |
| QA-PY-108    | 0%      | [0, 0.1936]      | 16         | 16  | 0   | 0      | 1           | 🔴 quarantine  |
| QA-SE-001    | 0%      | [0, 0.2775]      | 10         | 10  | 0   | 0      | 1           | 🔴 quarantine  |
| QA-SE-002    | 8%      | [0.0137, 0.3331] | 13         | 12  | 1   | 0      | 1           | 🔴 quarantine  |
| QA-SE-003    | 0%      | [0, 0.2588]      | 11         | 11  | 0   | 0      | 1           | 🔴 quarantine  |
...
## Coverage: 77/79 rules measured (97%) at n ≥ 10

**2 rules carry no measured FP rate.** Any of them in the
