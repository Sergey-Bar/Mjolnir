...
`release.yml`'s `action-tags` job moves the **`v2` major moving tag** to
...
| #   | Step                                                                               | State   |
| --- | ---------------------------------------------------------------------------------- | ------- |
| 1   | Merge P1; confirm `v2` tag moved by the action-tags job on the next stable release | pending |
