...
export function renderUnifiedReport(
  ...
  // ─── Hero header ───
  lines.push(
    '## <img width="16" src="https://raw.githubusercontent.com/Sergey-Bar/Mjolnir/main/assets/mjolnir-icon.svg"/> QA Doctor Verification Report',
  );
  lines.push("");
  lines.push(
  ...
  lines.push("");
  lines.push(
    `<sub>Advisory only — this comment never blocks merging. Generated by [QA Doctor](${options.repoUrl ?? "https://github.com/Sergey-Bar/Mjolnir"}).</sub>`,
  );
