...
export const TRUST_INVARIANTS: readonly TrustInvariant[] = [
  ...
  },
  {
    ...
    scope: "Scan",
    status: "CURRENT",
    verificationTest: "incremental-equivalence.spec.ts",
  },
  {
    id: "TI-006",
    description:
  ...
  },
  {
    ...
    scope: "Evidence",
    status: "CURRENT",
    verificationTest: "evidence-voting.spec.ts",
  },
  {
    id: "TI-010",
  ...
  },
  {
    ...
    scope: "Identity",
    status: "CURRENT",
    verificationTest: "run-identity-determinism.spec.ts",
  },
  {
    id: "TI-012",
  ...
  },
  {
    ...
    scope: "Plugins",
    status: "CURRENT",
    verificationTest: "tier-isolation.spec.ts",
  },
  {
    id: "TI-014",
    description:
  ...
  },
  {
    ...
    scope: "Evidence",
    status: "CURRENT",
    verificationTest: "trust-proximity.spec.ts",
  },
  {
    id: "TI-017",
  ...
  },
  {
    ...
    scope: "PR Comments",
    status: "CURRENT",
    verificationTest: "pr-comment-determinism.spec.ts",
  },
  {
    id: "TI-019",
    ...
    scope: "PR Comments",
    status: "CURRENT",
    verificationTest: "presentation-trust.spec.ts",
  },
  {
    id: "TI-020",
    description:
    ...
    scope: "PR Comments",
    status: "CURRENT",
    verificationTest: "stale-guard-ti020.spec.ts",
  },
] as const;
