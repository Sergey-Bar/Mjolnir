...
| 1.1.2   | Quarantine remediation: a generated, drift-locked ledger plus rework-or-retire of the worst measured rules ([QUARANTINE-REMEDIATION](https://github.com/Sergey-Bar/qa-doctor/blob/main/docs/QUARANTINE-REMEDIATION.md))                                            |
| 1.1.3   | Machine-verified blast-radius audit and containment fixes ([BLAST-RADIUS-AUDIT](https://github.com/Sergey-Bar/qa-doctor/blob/main/docs/BLAST-RADIUS-AUDIT.md))                                                                                                     |
| 1.1.4   | The [Trust Constitution](https://github.com/Sergey-Bar/qa-doctor/blob/main/docs/TRUST-CONSTITUTION.md) and the `qa-doctor release-trust` verdict gate ([RELEASE-TRUST-CONTRACT](https://github.com/Sergey-Bar/qa-doctor/blob/main/docs/RELEASE-TRUST-CONTRACT.md)) |
...
- **The 2.0 cutover**, on the breaking-set inventory and migration draft
  prepared above; [VERSIONING](https://github.com/Sergey-Bar/qa-doctor/blob/main/docs/VERSIONING.md)
