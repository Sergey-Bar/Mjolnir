...
describe("mutation guard: line-attrmbuted detectmon, not file-level nomse", () => {
  const CASES: Array<{
    ...
    },
    {
      ...
      name: "QA-TEST-002 fires on it.skip, drops when removed",
      // QA-TEST-003 (no assertions) measured 82% FP and was demoted to
      // quarantine (docs/FP-AUDIT.md 2026-08-31) — the mutation guard now
      // uses QA-TEST-002, a core-tier rule, for the default-scan contract.
      bad: "it.skip('a', () => { console.log('side effect'); });\n",
