...
- **Feature design debates** — proposals are welcome via issue forms or
  discussions; the maintainer's decision record (see the governance
  statement in [CONTRIBUTING.md](CONTRIBUTING.md)) is final.

## Response expectations

First response to a new issue is targeted within **7 days** — an honest
solo-maintainer commitment, not an SLA with consequences. If an issue
stalls, a polite ping is appropriate.
