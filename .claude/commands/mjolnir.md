...
<!-- mjolnir:managed v0.5.34 -->

Run `/npx mjolnir-qa@0.5.34 . --scope changed` before finishing any task that touched test code.
...
- npx mjolnir-qa@0.5.34 why <file>:<line> explains any finding (evidence level, measured FP rate, fix).
- npx mjolnir-qa@0.5.34 handoff renders a full remediation plan from a saved --json report.
