...
<!-- mjolnir:managed v0.5.28 -->

Run `/npx mjolnir-qa@0.5.28 . --scope changed` before finishing any task that touched test code.
...
- npx mjolnir-qa@0.5.28 why <file>:<line> explains any finding (evidence level, measured FP rate, fix).
- npx mjolnir-qa@0.5.28 handoff renders a full remediation plan from a saved --json report.
