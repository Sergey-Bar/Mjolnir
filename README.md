...
**<!-- census:measured-of-total -->77 of 78<!-- /census:measured-of-total --> rules carry a false-positive rate measured against real OSS code**
(≥ 10 hand-classified findings each — [docs/FP-AUDIT.md](docs/FP-AUDIT.md)).
The other <!-- census:unmeasured -->1<!-- /census:unmeasured --> ship on the author's estimate and say so, per rule, in
...
- **<!-- census:unmeasured-of-total -->1 of 78<!-- /census:unmeasured-of-total --> rules ship on an estimate**, not a measured rate — disclosed
