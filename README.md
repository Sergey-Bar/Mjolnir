...
gate. The default scan (`npx mjolnir-qa@4.0.0-rc.1 without `--strict`)
...
<p align="center">
  <a href="assets/video/mjolnir-demo.mp4">
    <img src="assets/video/mjolnir-demo-poster.png" alt="A frame of the demo recording: npx mjolnir-qa@4.0.0-rc.1 scanning the demo repository in a terminal window" width="900" />
  </a>
</p>
...
1. **Scan** — `npx mjolnir-qa@4.0.0-rc.1 — scans the current directory, prints the Trust Report, exits `1` if findings at the gate
2. **Block in CI** — `npx mjolnir-qa@4.0.0-rc.1 --scope changed` — scans only changed lines, blocks PRs with error findings
...
```bash
npx mjolnir-qa@4.0.0-rc.1 --scope changed --blocking error
```
...
```bash
npx mjolnir-qa@4.0.0-rc.1 --scope changed
```
...
```json
{
  "mcpServers": {
    "mjolnir": {
      "command": "npx",
      "args": ["-y", "mjolnir-qa@4.0.0-rc.1", "mcp"]
    }
  }
}
```
