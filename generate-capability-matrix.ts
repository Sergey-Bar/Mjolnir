...
import { wilsonInterval } from "./lib/wilson.ts";
...
import { RETIRED_RULE_IDS, RULES } from "../src/rules/index.ts";
import {
  MEASURED_FP,
  type MeasuredFp,
} from "../src/rules/measured-fp.generated.ts";
import {
  declaredDetectorRevision,
  effectiveTier,
  ruleStatus,
} from "../src/rules/measurement.ts";
import type { QADoctorRule } from "../src/rules/rule.ts";
